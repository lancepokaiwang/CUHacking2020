...
class DatabaseAccessObject
{
    ...
    private $mysql_username = "lancewgc_cuhack";
    private $mysql_password = "lancewgc_cuhack";
    private $mysql_database = "lancewgc_cuhacking2020";
    private $link;
    private $last_sql = "";
    private $last_id = 0;
    ...
    {
        $this->mysql_address = "localhost";
        $this->mysql_username = "lancewgc_cuhack";
        $this->mysql_password = "lancewgc_cuhack";
        $this->mysql_database = "lancewgc_cuhacking2020";
