...
tweets = bfs.readJsonFile(name="tweets_preprocessed", folder="data").items()
output_tf_idf = {}
...
bfs.writeJsonFile(output_tf_idf, "tweets_tf", "data")

for i, document in output_tf_idf.items():
    document["body"] = tf_idf_document(document["body"], corpus_body)

bfs.writeJsonFile(output_tf_idf, "tweets_tf_idf", "data")
bfs.writeJsonFile(output_dataset_processed, "processed_tweets_text", "data")
